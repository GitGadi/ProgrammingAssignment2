...
## set the value of the inverse matrix - setinverse(inverse)
## get the value of the inverse matrix - setinverse()
...
## Otherwise, it calculates the inverse matrix using the function solve,
